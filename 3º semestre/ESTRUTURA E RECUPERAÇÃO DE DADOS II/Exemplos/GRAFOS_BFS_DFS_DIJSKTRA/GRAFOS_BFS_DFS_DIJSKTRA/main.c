...
int main() {
    ...
    do {
        ...
        printf("Digite 9 para Buscar o caminho minimo entre dois vertices (Dijkstra)!\n");
        ...
        switch(opcao) {
            ...
            case 8:
                ...
                break;
            case 9:
                printf("Digite o vertice de inicio para a busca do caminho minimo:\n");
                scanf(" %c", &inicio);
                printf("Digite o vertice de fim para a busca do caminho minimo:\n");
                scanf(" %c", &fim);
                int *distancias = malloc(obterNumeroVertices(grafo1)* sizeof(int));
                int *pais = malloc(obterNumeroVertices(grafo1) * sizeof(int));
                dijkstra(grafo1, inicio, distancias, pais);
                imprimirCaminhoMinimo(grafo1, inicio, fim, distancias, pais);
                free(distancias);
                free(pais);
                break;
            default:
